...
public static class WebApplicationBuilderExtensions
{
    ...
    public static WebApplicationBuilder AddServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services
            ...
            .AddTransient<IActivitySessionService, ActivitySessionService>()
            .AddTransient<IGoalService, GoalService>()
            .AddTransient<IWorkoutProgramService, WorkoutProgramService>()
            .AddTransient<IUserWorkoutSubscriptionService,  UserWorkoutSubscriptionService>()
